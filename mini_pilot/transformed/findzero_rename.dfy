...
method SearchZero(ll: Node?) returns (r: int)
            ...
            (r == |ll.List| ==> 0 !in ll.List)
{
  if ll == null {
    ...
    var cursor := ll;
    var skipped := 0;
    while cursor != null && cursor.head != 0
      invariant cursor != null ==> cursor.Valid() && skipped + |cursor.List| == |ll.List| && ll.List[skipped..] == cursor.List
      invariant cursor == null ==> skipped == |ll.List|
      invariant 0 !in ll.List[..skipped]
      decreases |ll.List| - skipped
    {
      cursor := cursor.next;
      skipped := skipped + 1;
    }
